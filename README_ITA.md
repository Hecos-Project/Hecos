...
# Hecos - Versione 0.27.4 (Runtime Alpha)
...
*Una piattaforma potente che unisce l'intelligenza artificiale all'esecuzione di sistema — funziona perfettamente sia con che senza AI, attraverso i flussi di automazione e i comandi diretti.*

---

> **Stato Runtime Alpha**: Hecos è attualmente in `v0.27.4`. Questo è un Helping Companion System locale che funge da ponte tra il ragionamento ad alto livello e l'esecuzione di sistema root.
...
Ora completamente migrato a una **architettura stabile a Runtime Alpha**, Hecos 0.27.4 offre una interfaccia Web dedicata (Chat + Config) e internazionalizzazione completa. Grazie a **LiteLLM**, supporta Ollama, KoboldCpp e i principali provider cloud con streaming in tempo reale e TTS locale.
...
* 🔑 **Backend Universale & Key Manager** — Usa modelli locali o connettiti a provider cloud. Anche nella seconda opzione, lavora in sicurezza e gratuitamente tramite il Key Manager integrato che gestisce chiavi API multiple per ogni provider.
...
## 📚 Documentazione
- 📖 **[Guida Unificata (ITA)](docs/GUIDA_UNIFICATA_ITA.md)**: Tutto ciò che devi sapere sulla v0.27.4.
