...
# Hecos - Versione 0.24.0 (Runtime Alpha)
...
> **Stato Runtime Alpha**: Hecos è attualmente in `v0.24.0`. Questo è un Helping Companion System locale che funge da ponte tra il ragionamento ad alto livello e l'esecuzione di sistema root.
...
Ora completamente migrato a una **architettura stabile a Runtime Alpha**, Hecos 0.24.0 offre una interfaccia Web dedicata (Chat + Config) e internazionalizzazione completa. Grazie a **LiteLLM**, supporta Ollama, KoboldCpp e i principali provider cloud con streaming in tempo reale e TTS locale.

---

## ✨ Caratteristiche Principali (v0.24.0)
...
## 📚 Documentazione
- 📖 **[Guida Unificata (ITA)](docs/GUIDA_UNIFICATA_ITA.md)**: Tutto ciò che devi sapere sulla v0.24.0.
