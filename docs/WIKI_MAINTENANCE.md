...
2. **Run the deployment script**:
   ...
   ```
   *(Note: By default, it looks for the Wiki repo at `C:\Zentra-Core-Wiki`. If yours is elsewhere, use `.\scripts\Auto-Wiki-Deploy.ps1 -WikiPath "D:\your\path"`)`*
...
- **Archive**: Original Wiki assets are located in the `Zentra-Core-Wiki` repository.
...
---
*Maintained by the Zentra Core Development Team*
