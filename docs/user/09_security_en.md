# 🛡️ 9. Advanced Security (Hecos PKI)

Hecos puts security at the center, especially when accessing the interface from other devices.

- **Hecos CA**: The system acts as its own Certification Authority (Root CA), generating secure and unique HTTPS certificates for your machine.
...
- **3-Tier Privacy (v0.24.0)**: The WebUI provides granular controls over data persistence:
