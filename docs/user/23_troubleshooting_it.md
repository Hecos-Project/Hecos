...
- **Problemi Audio**: Verifica che il microfono sia selezionato correttamente nel pannello **F7** sotto `AUDIO`. Se usi la WebUI, assicurati di aver accettato i certificati di sicurezza Hecos PKI.
...
1. Apri il **Pannello di Controllo di Hecos** (F7 o `/hecos/config/ui`).
