# 🛠️ 24. Resolución de Problemas Hardware

Si encuentras dificultades, sigue estos pasos rápidos para restaurar el funcionamiento correcto de Hecos.
...
- **Problemas de Audio**: Verifica que el micrófono esté seleccionado correctamente en el panel **F7** bajo `AUDIO`. Si usas la WebUI, asegúrate de haber aceptado los certificados de seguridad Hecos PKI.
...
1. Abre el **Panel de Control de Hecos** (F7 o `/hecos/config/ui`).
