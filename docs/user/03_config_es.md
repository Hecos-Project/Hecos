...
Hecos proporciona teclas de función (F1-F7) para interactuar y re-parametrizar el sistema en tiempo real, con memoria permanente.
...
* **[ F3 ] CARGAR ALMA / PERSONALIDAD:** Cambia el tono y la conciencia del sistema. Hecos escanea automáticamente la carpeta `/personality/` al iniciar.
...
A través de una interfaz gráfica basada en menús, ofrece control granular sobre Hecos. Permite editar parámetros booleanos, numéricos o de texto.
