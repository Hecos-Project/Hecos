...
- **Push-to-Talk (PTT)**: Use the Microphone button next to the chat box.
  ...
  - **Hands-Free (Toggle)**: Quick tap 🎙️ to lock recording (🔴 🔓). Tap again to stop.
- **Neural TTS Autoplay**: Audio synthesis starts automatically even on mobile browsers thanks to a custom HTML5 proxy player.
