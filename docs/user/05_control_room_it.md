...
A differenza della Chat principale, incentrata sulla conversazione, la Control Room ti offre una visione permanente e immediata del tuo sistema e dei tuoi dati. Pensala come il tuo **pannello di controllo missione**: uno spazio che puoi riempire con le informazioni che ti interessano.
...
La Control Room utilizza una **griglia drag-and-drop** (alimentata da GridStack). Puoi:
- **Aggiungere widget** dalla Libreria Pacchetti.
- **Ridimensionare** qualsiasi widget trascinandone l'angolo.
- **Riordinare** i widget liberamente — il layout viene salvato automaticamente.
- **Rimuovere** un widget dalla room senza disinstallarlo.

## Widget Inclusi (Esempi)

| Widget | Descrizione |
|--------|-------------|
| **OS Telemetry** | Grafici in tempo reale di CPU, RAM e VRAM. |
| **Weather Pro** | Meteo live e previsioni a 7 giorni. |
