...
Hecos's WebUI is the modern graphical interface accessible through your browser.
...
- **Graphical Configuration**: Allows you to modify every aspect of Hecos through intuitive menus, without having to manually edit YAML files.
- **Microphone and Camera**: Thanks to Hecos PKI encryption, you can use your browser's microphone and webcam to interact with the AI even remotely on your local network.
...
- **Current Version**: `0.23.0` (Runtime Alpha)
