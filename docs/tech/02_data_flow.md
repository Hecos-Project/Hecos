...
The flow of information in Hecos follows a structured path to ensure speed and security.
...
3.  **Tool Calling**: If necessary, the AI activates the required modules/tools (e.g., `SYSTEM`, `FILES`, `IMAGES`).
