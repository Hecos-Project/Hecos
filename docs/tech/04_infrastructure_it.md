...
- **Loguru**: Sistema di logging avanzato per il monitoraggio e il debugging.
- **Pydantic**: Validazione rigorosa degli schemi di configurazione e dei dati in transito.
