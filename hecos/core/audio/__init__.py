...
IMPORT PATTERNS (used by external consumers):
    from hecos.core.audio import listen    → use as listen.listen()
    from hecos.core.audio import voice    → use as voice.speak()
    from hecos.core.audio import ptt_bus  → use as ptt_bus.fire_ptt()
    from hecos.core.audio.voice import speak  → direct function import
