...
Multi-key with optional inline description (comment after #):
    ...
    GEMINI_API_KEY_1=AIzaSy...        # Google AI Studio - progetto Hecos
...
from hecos.core.keys.key_store import ApiKeyEntry, STATUS_UNKNOWN
from hecos.core.logging import logger

# Try to import YAML loader (used by Hecos config)
try:
    import yaml
...
# Root project directory: the 'hecos/' black-box folder
# key_loader.py is at: hecos/core/keys/key_loader.py
# .parent        → hecos/core/keys/
# .parent.parent → hecos/core/
# .parent.parent.parent → hecos/   ← BLACK BOX ROOT
