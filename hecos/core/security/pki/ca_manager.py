...
class CAManager:
    """Gestisce la Hecos Local Root CA (Generazione, Caricamento e Salvataggio)"""
    
    def __init__(self, ca_dir=None):
        if ca_dir is None:
            # hecos/core/security/pki/ca_manager.py -> ../../../ is hecos/
    ...
    def generate_ca(self):
        ...
        print("[PKI] Generating new Hecos Root CA...")
        ...
        subject = issuer = x509.Name([
            ...
            x509.NameAttribute(NameOID.STATE_OR_PROVINCE_NAME, u"Hecos State"),
            x509.NameAttribute(NameOID.LOCALITY_NAME, u"Hecos Local Network"),
            x509.NameAttribute(NameOID.ORGANIZATION_NAME, u"Hecos Authority"),
            x509.NameAttribute(NameOID.COMMON_NAME, u"Hecos Local Root CA"),
        ])
        ...
        print("[PKI] Hecos Root CA generated and saved successfully.")
