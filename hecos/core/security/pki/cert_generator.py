...
class CertGenerator:
    """Genera certificati Host firmati dalla Hecos Root CA"""

    def __init__(self, ca_manager, certs_dir=None):
        self.ca = ca_manager
        if certs_dir is None:
            # hecos/core/security/pki/cert_generator.py -> ../../../ is hecos/
    ...
    def generate_host_cert(self, local_ip="127.0.0.1"):
        ...
        subject = x509.Name([
            ...
            x509.NameAttribute(NameOID.ORGANIZATION_NAME, u"Hecos"),
        ...
        print("[PKI] Host certificate generated and signed with Hecos Root CA.")
        return self.cert_path, self.key_path
