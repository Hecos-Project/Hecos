"""
Plugin: WEB_UI
Serves the Hecos native chat interface and config panel on localhost:7070.
"""
import os
import sys
import logging
...
class WebUIPlugin:
    ...
    def open_browser(self, **kwargs) -> str:
        """Opens the Hecos web interface in the default browser if not already open."""
        self._ensure_server()
        scheme = self._get_scheme()
