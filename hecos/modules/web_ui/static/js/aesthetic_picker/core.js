class HecosAestheticPicker {
    constructor(containerEl, options) {
        ...
        this.options = Object.assign({
            ...
            showHex: false,
            showPalette: true,
            colorLabel: window.t ? window.t('Background Color') : 'Background Color',
            imageLabel: window.t ? window.t('Background Image') : 'Background Image',
            styleLabel: window.t ? window.t('Panel Theme') : 'Panel Theme',
            onColorChange: (val) => {},
            onColorLive: (val) => {},
            onImageChange: (path) => {},
            onClearImage: () => {},
