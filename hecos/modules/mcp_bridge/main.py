    ...
    def get_tool_schemas(self):
        ...
        for server_name, proxy in self.proxies.items():
            for t in proxy.tools:
                ...
                # Hecos flattens this using double underscore
...
# Custom tools object to satisfy Hecos's loader
class DynamicTools:
    ...
    def get_mcp_schemas(self):
        """Hook used by Hecos's module_docs.py to merge tools."""
        return self._bridge.get_tool_schemas()

    # NOTE: Hecos's processor looks for methods on this object.
