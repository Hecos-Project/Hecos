...
from hecos.ui.interface import get_hardware_row
...
def start(config_manager, state_manager, dashboard_module, interval: float = 2.0):
    ...
    _updater_thread = threading.Thread(target=_update_cycle, args=(interval,), daemon=True, name="HecosUIUpdater")
